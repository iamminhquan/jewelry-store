...
ADD CONSTRAINT fk_sanpham_bosuutap
FOREIGN KEY
(bo_suu_tap)
REFERENCES BoSuuTap
(ma_bo_suu_tap),
...
ADD CONSTRAINT fk_loaisanpham_danhmuc
FOREIGN KEY (ma_danh_muc)
REFERENCES DanhMuc(ma_danh_muc);
...
ADD CONSTRAINT fk_danhgia_taikhoan
FOREIGN KEY
(nguoi_danh_gia)
REFERENCES TaiKhoan
(ma_tai_khoan);
...
-- =========================
ALTER TABLE DonHang
ADD CONSTRAINT fk_donhang_taikhoan
FOREIGN KEY (ma_tai_khoan)
REFERENCES TaiKhoan(ma_tai_khoan);
...
ADD CONSTRAINT fk_kichthuocsanpham_sanpham
FOREIGN KEY (ma_san_pham)
REFERENCES SanPham(ma_san_pham);
...
ALTER TABLE SanPham
ADD CONSTRAINT fk_sanpham_hinhanh
FOREIGN KEY (hinh_anh)
REFERENCES HinhAnhSanPham(ma_hinh_anh);
